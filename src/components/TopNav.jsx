...
import { HardHat, CalendarDays, CalendarRange, ClipboardList, ClipboardCheck, CheckSquare, BarChart3 } from "lucide-react";
...
const ALL_NAV_ITEMS = [
  ...
  { to: "/klaf", label: "המשימות שלי", icon: CheckSquare, roles: ["admin", "קלפ"] },
];
...
export default function TopNav() {
  ...
  const items = ALL_NAV_ITEMS.filter((item) => !user || item.roles.includes(effectiveRole));
